    ...
    <div className="container mx-auto py-8 px-4 md:px-6 max-w-6xl">
      <div className="space-y-12">
        ...
        <AnimatedSection className="text-center space-y-4">
          ...
          <p className="text-base text-black/40 dark:text-white max-w-3xl mx-auto">
          ...
          <motion.div whileHover={{ scale: 1.015 }}>
            <Card className="bg-transparent">
              <CardHeader>
                ...
                <CardDescription className="text-base text-black/40 dark:text-white">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="text-center space-y-4">
                    ...
                    <h3 className="text-xl font-semibold text-black/50 dark:text-white/70">1. Retrieval</h3>
                    <p className="text-black/40 dark:text-white text-sm lg:text-base">
                  ...
                  <div className="text-center space-y-4">
                    ...
                    <h3 className="text-xl font-semibold text-black/50 dark:text-white/70">2. Augmentation</h3>
                    <p className="text-black/40 dark:text-white text-sm lg:text-base">
                  ...
                  <div className="text-center space-y-4">
                    ...
                    <h3 className="text-xl font-semibold text-black/50 dark:text-white/70">3. Generation</h3>
                    <p className="text-black/40 dark:text-white text-sm lg:text-base">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <AnimatedSection className="block-container">
                <motion.div whileHover={{ scale: 1.03, transition: { duration: 0.2 } }} className="h-full">
                  <div className="p-6 border rounded-xl space-y-4 h-full"> {/* Added h-full for consistent height if needed */}
                    <h4 className="text-lg font-semibold text-black/50 dark:text-white/70">Frontend</h4>
              ...
              <AnimatedSection className="block-container">
                <motion.div whileHover={{ scale: 1.03, transition: { duration: 0.2 } }} className="h-full">
                  <div className="p-6 border rounded-xl space-y-4 h-full"> {/* Added h-full */}
                    <h4 className="text-lg font-semibold text-black/50 dark:text-white/70">AI & Machine Learning</h4>
                    <div className="space-y-2 text-sm text-black/40 dark:text-white">
                      <div className="flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-lg font-medium text-black/50 dark:text-white/70">Accurate Responses</h4>
                        <p className="text-black/40 dark:text-white text-base lg:text-base">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-lg font-medium text-black/50 dark:text-white/70">Multi-format Support</h4>
                        <p className="text-black/40 dark:text-white text-base lg:text-base">
                  ...
                  <div className="space-y-6">
                    <div>
                      <h4 className="text-lg font-medium text-black/50 dark:text-white/70">Fast Processing</h4>
                      <p className="text-black/40 dark:text-white text-sm lg:text-base">
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-black/50 dark:text-white/70">Natural Language</h4>
                      <p className="text-black/40 dark:text-white text-sm lg:text-base">
          ...
          <motion.div whileHover={{ scale: 1.015 }}>
            <Card className="bg-transparent">
              <CardHeader>
                ...
                <CardDescription className="text-base text-black/40 dark:text-white">The creator behind this Document Analyzer</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
                  ...
                  <div className="flex-1 text-center md:text-left space-y-4">
                    ...
                    <div className="flex justify-center md:justify-start gap-4">
                      <Link href="https://github.com/chinni-d" target="_blank" className="text-black/40 dark:text-white hover:text-foreground transition-colors">
                        <Github className="h-6 w-6" />
                        <span className="sr-only">GitHub</span>
                      </Link>
                      <Link href="https://www.linkedin.com/in/manikanta-darapureddy-6a1125314/" target="_blank" className="text-black/40 dark:text-white hover:text-foreground transition-colors">
                        <Linkedin className="h-6 w-6" />
                        <span className="sr-only">LinkedIn</span>
                      </Link>
                      <Link href="mailto:darapureddymanikanta8@gmail.com" target="_blank" className="text-black/40 dark:text-white hover:text-foreground transition-colors">
                        <Mail className="h-6 w-6" />
                        <span className="sr-only">Email</span>
                      </Link>
                      <Link href="https://www.dmanikanta.site/" target="_blank" className="text-black/40 dark:text-white hover:text-foreground transition-colors">
